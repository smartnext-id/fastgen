...
// GET TOKENS
app.get('/api/getTokens', verifyToken, async (req, res) => {
...
// DEDUCT TOKENS
app.post('/api/deductTokens', verifyToken, async (req, res) => {
    const userId = req.user.userId;
...
// ENHANCE PROMPT
app.post('/api/enhancePrompt', verifyToken, async (req, res) => {
