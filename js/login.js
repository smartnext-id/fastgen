...
    // Diperbaiki: URL sekarang memiliki satu slash (/) yang benar.
    const BACKEND_URL = "https://fastgen-ten.vercel.app/backend";
    
    function uuidv4() { return ([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g, c => (c ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> c / 4).toString(16)); }
    const client_id = uuidv4();

    // Baris ini akan menyebabkan error 404 karena mencoba terhubung ke ComfyUI lokal dari Vercel.
    // Logika ini akan digantikan oleh `queue_prompt` yang dimodifikasi di bawah.
